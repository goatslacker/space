(function() {
  ...
  Element = (function() {
    ...
    Element.prototype.animate = function(el, getXY) {
      return Game.animate(function(delta) {
        var x, y, _ref;
        _ref = getXY(), x = _ref[0], y = _ref[1];
        return el.translate(x * delta / 16, y * delta / 16);
      });
    };
    return Element;
  })();
  Missile = (function() {
    ...
    Missile.prototype.acceleration = 10;
    Missile.prototype.weight = 100;
    Missile.prototype.fire = function(aim, power) {
      var speed;
      if (aim == null) {
        aim = 0;
      }
      ...
      return this.animate(this.value, (__bind(function() {
        this.x = this.x + speed;
        this.y = this.y + speed;
        return [speed, 0];
      }, this)));
  ...
  SmallMissile = (function() {
    ...
    SmallMissile.prototype.speed = 10;
    SmallMissile.prototype.acceleration = 100;
    SmallMissile.prototype.fire = function() {
      return SmallMissile.__super__.fire.apply(this, arguments);
    };
    return SmallMissile;
  })();
  Planet = (function() {
